...
class DependenciesSizeSpec extends ObjectBehavior
{
    ...
    function let(ReflectionClass $sus, ReflectionMethod $reflectionMethod)
    {
    ...
    function it_does_not_complain_if_the_number_of_dependencies_are_low(ReflectionClass $sus, Params $params, Reporter $reporter, ReflectionMethod $reflectionMethod)
    {
        ...
        $reporter->act($sus, self::class, 'Dependencies size', 'Dependencies size')->shouldNotBeCalled();
        $this->shouldNotThrow(DependenciesSizeTooLarge::class)->duringCheck($sus, $params, $reporter);
    }
