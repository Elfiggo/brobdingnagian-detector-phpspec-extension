...
class ClassSizeSpec extends ObjectBehavior
{
    ...
    function it_complains_if_class_size_is_too_large(ReflectionClass $sus, Params $params, Reporter $reporter)
    {
        ...
        $reporter->act($sus, 'Elfiggo\Brobdingnagian\Detector\ClassSize', 'Elfiggo/Brobdingnagian/Detector/ClassSize size is too large (301)')->willThrow(ClassSizeTooLarge::class);
